...
app.use('/api/bins', routes.bin);
app.use('/api/zone', routes.zone);
app.use('/api/district', routes.district);
app.use('/api/ward', routes.ward);
app.use('/api/vehicletype', routes.vehicletype);
app.use('/api/house', routes.house);
app.use('/api/supervisor', routes.supervisor);
